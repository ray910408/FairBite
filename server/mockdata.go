...
var mockRestaurants = []Restaurant{
	{PlaceID: "mock-001", Name: "阿宗麵線", PrimaryType: "noodle_shop", CuisineTags: []string{"noodle"}, PriceLevel: 0, Lat: 25.0466, Lng: 121.5076, Address: "萬華區峨眉街8-1號", Hours: daily([2]int{660, 1350}), Rating: 4.4},
	...
	{PlaceID: "mock-010", Name: "林東芳牛肉麵", PrimaryType: "noodle_shop", CuisineTags: []string{"beef_noodle"}, PriceLevel: 1, Lat: 25.0478, Lng: 121.5260, Address: "中山區八德路二段", Hours: daily([2]int{660, 180}), Rating: 4.5},
