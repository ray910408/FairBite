...
var mockRestaurants = []Restaurant{
	...
	{PlaceID: "mock-004", Name: "添好運", PrimaryType: "dim_sum_restaurant", CuisineTags: []string{"cantonese", "dimsum"}, PriceLevel: 2, Lat: 25.0460, Lng: 121.5175, Address: "中正區忠孝西路一段36號", Hours: daily([2]int{600, 1290}), Rating: 4.1},
	...
	{PlaceID: "mock-006", Name: "慕里諾牛排館", PrimaryType: "steak_house", CuisineTags: []string{"steak", "western"}, PriceLevel: 4, Lat: 25.0500, Lng: 121.5150, Address: "大同區承德路一段", Hours: daily([2]int{690, 1260}), Rating: 4.5},
	...
	{PlaceID: "mock-008", Name: "老四川麻辣鍋", PrimaryType: "hot_pot_restaurant", CuisineTags: []string{"hotpot", "sichuan"}, PriceLevel: 3, Lat: 25.0512, Lng: 121.5195, Address: "大同區南京西路", Hours: daily([2]int{1020, 120}), Rating: 4.4},
	{PlaceID: "mock-009", Name: "沙巴印度咖哩", PrimaryType: "indian_restaurant", CuisineTags: []string{"indian", "curry", "halal_certified"}, PriceLevel: 1, Lat: 25.0430, Lng: 121.5190, Address: "中正區開封街一段", Hours: daily([2]int{660, 1260}), Rating: 4.1},
	{PlaceID: "mock-010", Name: "林東芳牛肉麵", PrimaryType: "noodle_shop", CuisineTags: []string{"taiwanese", "beef_noodle"}, PriceLevel: 1, Lat: 25.0478, Lng: 121.5260, Address: "中山區八德路二段", Hours: daily([2]int{660, 180}), Rating: 4.5},
	{PlaceID: "mock-011", Name: "早安美芝城", PrimaryType: "breakfast_restaurant", CuisineTags: []string{"breakfast", "taiwanese"}, PriceLevel: 0, Lat: 25.0485, Lng: 121.5140, Address: "大同區太原路", Hours: daily([2]int{330, 840}), Rating: 3.9},
