...
var mockRestaurants = []Restaurant{
	...
	{PlaceID: "mock-009", Name: "沙巴印度咖哩", PrimaryType: "indian_restaurant", CuisineTags: []string{"indian", "curry"}, PriceLevel: 1, Lat: 25.0430, Lng: 121.5190, Address: "中正區開封街一段", Hours: daily([2]int{660, 1260}), Rating: 4.1},
